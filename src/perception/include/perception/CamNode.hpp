...
#include "perception_interfaces/msg/lane.hpp"
...
private:
  ...
  rclcpp::Publisher<perception_interfaces::msg::Lane>::SharedPtr lane_left_pub_;
  rclcpp::Publisher<perception_interfaces::msg::Lane>::SharedPtr lane_right_pub_;
};
